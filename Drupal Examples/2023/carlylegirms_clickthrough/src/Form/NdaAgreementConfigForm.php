 ...
 */
class NdaAgreementConfigForm extends ConfigFormBase {
  ...
  protected function getEditableConfigNames() {
    return [
      'carlylegirms_clickthrough.adminsettings',
    ];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('carlylegirms_clickthrough.adminsettings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('carlylegirms_clickthrough.adminsettings')
